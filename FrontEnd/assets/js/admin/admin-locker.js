document.addEventListener('DOMContentLoaded', function() {
    ...
    uploadForm.addEventListener('submit', async (e) => {
        ...
        try {
            ...
            const response = await fetch('../../../BackEnd/api/admin/postLockerUpload.php', {
                method: 'POST',
                body: formData
            });
    ...
    async function loadFiles() {
        ...
        try {
            const response = await fetch('../../../BackEnd/api/admin/getLockerFiles.php');
            const result = await response.json();
    ...
    function createFileCard(file) {
        ...
        card.querySelector('.download-btn').addEventListener('click', (e) => {
            e.stopPropagation();
            window.location.href = `../../../BackEnd/api/admin/getLockerDownload.php?fileId=${file.Locker_File_Id}`;
        });
    ...
    async function deleteFile(fileId) {
        ...
        try {
            const response = await fetch('../../../BackEnd/api/admin/postLockerDelete.php', {
                method: 'POST',
                headers: {
    ...
    function showPreview(file) {
        ...
        const previewUrl = `../../../BackEnd/api/admin/getLockerPreview.php?fileId=${file.Locker_File_Id}`;
